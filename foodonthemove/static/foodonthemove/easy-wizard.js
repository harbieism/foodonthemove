            ...
            return this.each(function() {
                ...
                if(thisSettings.steps > 1) {
                    ...
                    if(thisSettings.showButtons) {
                        paginationHtml = '<div class="easyWizardButtons text-center">';
                        paginationHtml += '<button class="btn btn-default prev '+thisSettings.buttonsClass+'">'+thisSettings.prevButton+'</button>';
                        paginationHtml += '<button class="btn btn-default next '+thisSettings.buttonsClass+'">'+thisSettings.nextButton+'</button>';
